...
_FAMILY_CONFIG: Dict[str, Dict[str, Any]] = {
    ...
    "tumbler": {
        "suffix": "20 oz Tumbler",
        "tags": ["tumbler", "gift idea", "drinkware"],
        "description_closing": "Built for everyday carry with practical hot-or-cold drink use and expressive personality.",
    },
    "travel_mug": {
        "suffix": "Travel Mug",
...
def build_branded_description(*, artwork_title: str, short_description: str, template: Any) -> str:
    ...
    use_case_by_family = {
        ...
        "tote": "Perfect for reusable carry, books, errands, market runs, and everyday accessory styling.",
        "poster": "Works beautifully as wall art in offices, bedrooms, studios, and gallery-style rooms.",
        "framed_poster": "Designed to feel elevated as ready-to-display wall decor and giftable art.",
        ...
        "tumbler": "Great for commuting, workouts, and daily hot-or-cold drink routines.",
        "travel_mug": "A practical companion for commutes, travel days, and desk coffee sessions.",
        "canvas": "A statement-ready wall art format for home display, room mood, and giftable decor.",
        "blanket": "A cozy throw-friendly accent for sofas, reading corners, and expressive home decor.",
